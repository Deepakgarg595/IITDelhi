...
public class ClientReportModel implements Parcelable {
    public ClientReportModel(){

    }
    protected ClientReportModel(Parcel in) {
    ...
    public static final Creator<ClientReportModel> CREATOR = new Creator<ClientReportModel>() {
        @Override
        public ClientReportModel createFromParcel(Parcel in) {
            return new ClientReportModel(in);
        }

        @Override
        public ClientReportModel[] newArray(int size) {
            return new ClientReportModel[size];
        }
    };
