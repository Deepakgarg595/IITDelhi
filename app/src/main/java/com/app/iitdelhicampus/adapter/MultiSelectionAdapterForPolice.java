...
public class MultiSelectionAdapterForPolice extends RecyclerView.Adapter<MultiSelectionAdapterForPolice.ViewHolder> {
    private final Context context;
    private ArrayList<CommonDropdownModel> details;

    public MultiSelectionAdapterForPolice(Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new MultiSelectionAdapterForPolice.ViewHolder(itemView);
    }
