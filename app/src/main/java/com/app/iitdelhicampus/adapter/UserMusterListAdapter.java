...
public class UserMusterListAdapter extends RecyclerView.Adapter<UserMusterListAdapter.ViewHolder> {
    private Context context;
    private List<MonthShiftDetailListModel> details;

    public UserMusterListAdapter(Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new UserMusterListAdapter.ViewHolder(itemView);
    }
