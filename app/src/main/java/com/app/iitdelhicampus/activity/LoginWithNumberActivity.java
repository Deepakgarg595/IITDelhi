...
public class LoginWithNumberActivity extends BaseActivity implements View.OnClickListener, OnUpdateResponse {
...
//            showDeviceTokenAlertDialog(this, "", "Device token is not updated, Please refresh token.");
            try {
                FirebaseInstanceId.getInstance().getInstanceId().addOnSuccessListener(LoginWithNumberActivity.this, new OnSuccessListener<InstanceIdResult>() {
                    @Override
...
//            DataStatic.getInstance().updateFCMToken();
    ...
    private void verifiedSuccess() {
        ...
        Intent intent = new Intent(LoginWithNumberActivity.this, clz);
...
//                preferences.setPhone(Utility.replaceFirstZero(phoneNumber.getText().toString().trim()));
                dialog.dismiss();
                Intent intent = new Intent(LoginWithNumberActivity.this, VerificationActivity.class);
                startActivity(intent);
...
//                            Toast.makeText(LoginWithNumberActivity.this, "Verification Success", Toast.LENGTH_LONG).show();
                            ...
                            if (task.getException() instanceof FirebaseAuthInvalidCredentialsException) {
                                Toast.makeText(LoginWithNumberActivity.this, "Verification Failed, Invalid credentials", Toast.LENGTH_LONG).show();
                            }
                            etOtpHolder.getText().clear();
                            btnVerifyOTP.setEnabled(true);
                            pbar.setVisibility(View.GONE);
...
//                Toast.makeText(LoginWithNumberActivity.this, "Verification Completed.", Toast.LENGTH_LONG).show();
            ...
            public void onVerificationFailed(FirebaseException e) {
                Toast.makeText(LoginWithNumberActivity.this, e.getMessage(), Toast.LENGTH_LONG).show();
                btnVerifyOTP.setEnabled(true);
                btnVerifyNumber.setEnabled(true);
                pbar.setVisibility(View.GONE);
                etOtpHolder.getText().clear();
            ...
            public void onCodeSent(String verificationId,
                ...
                Toast.makeText(LoginWithNumberActivity.this, "Verification Code Sent.", Toast.LENGTH_LONG).show();
                pbar.setVisibility(View.GONE);
                        ...
                        if (task.isSuccessful()) {
                            if (task.getResult().size() > 0) {
                                for (QueryDocumentSnapshot document : task.getResult()) {
                                    ...
                                    LoopJRequestHandler.getInstance().hitApiGetMethod(Constants.CHECK_USER + preferences.getPhone(), LoginWithNumberActivity.this, Constants.RequestType.SEND_OTP);
