...
// */
//
//package com.app.orionsecure.tabs;
//
...
//
//        defaultTabOneButtonIcon = context.getResources().getDrawable(R.mipmap.app_icon);
//        defaultTabTwoButtonIcon = context.getResources().getDrawable(R.mipmap.app_icon);
//        defaultTabThreeButtonIcon = context.getResources().getDrawable(R.mipmap.app_icon);
//        defaultTabFourButtonIcon = context.getResources().getDrawable(R.mipmap.app_icon);
//        defaultTabFiveButtonIcon = context.getResources().getDrawable(R.mipmap.app_icon);
//
...
//
//            }else if (attr == R.styleable.SpaceTabLayout_text_four) {
//                text_four = a.getString(attr);
//
//            }else if (attr == R.styleable.SpaceTabLayout_text_five) {
//                text_five = a.getString(attr);
//
//            }
//        }
//        a.recycle();
...
//            tabFour.setCustomView(R.layout.icon_text_tab_layout);
//            tabFive.setCustomView(R.layout.icon_text_tab_layout);
//
//            tabs.add(tabOne);
//            tabs.add(tabTwo);
//            tabs.add(tabThree);
...
//            tabFourImageView = (ImageView) tabFive.getCustomView().findViewById(R.id.tabImageView);
...
////            if (text_four != null) setTabFourText(text_four);
////            if (text_five != null) setTabFiveText(text_five);
//
